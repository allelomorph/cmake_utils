...
if(NOT SDL_MIXER_DEFAULT_VERSION OR
    "${SDL_MIXER_DEFAULT_VERSION}" VERSION_LESS "${SDL_MIXER_MINIMUM_VERSION}")
  set(SDL_MIXER_TARGET_VERSION "${SDL_MIXER_MINIMUM_VERSION}")
else()
  set(SDL_MIXER_TARGET_VERSION "${SDL_MIXER_DEFAULT_VERSION}")
endif()
