...
#   queries system package manager to get default version of SDL2_rtf library,
#     caching SDL2_RTF_DEFAULT_VERSION in <major>.<minor>.<patch> format
...
if(DEFINED CACHE{SDL2_RTF_DEFAULT_VERSION})
  return()
endif()
...
unset(_SDL2_RTF_DEFAULT_VERSION)

if(${PACKAGE_MANAGER_BINARY} MATCHES "/brew$")

  # MacOS: homebrew
  default_package_version("sdl2_rtf"          _SDL2_RTF_DEFAULT_VERSION)

elseif(${PACKAGE_MANAGER_BINARY} MATCHES "/aptitude$" OR
    ${PACKAGE_MANAGER_BINARY} MATCHES "/apt$")

  # Debian: aptitude > apt [> dpkg]
  default_package_version("libsdl2-rtf-2.0-0" _SDL2_RTF_DEFAULT_VERSION)
...
elseif(${PACKAGE_MANAGER_BINARY} MATCHES "/emerge")
  ...
  default_package_version("sdl2-rtf"          _SDL2_RTF_DEFAULT_VERSION)

elseif(${PACKAGE_MANAGER_BINARY} MATCHES "/zypper$")

  # openSUSE: zypper [> rpm]
  # note: passing "" to `zypper info` will list all packages
  default_package_version("libSDL2_rtf-2_0-0" _SDL2_RTF_DEFAULT_VERSION)
...
set(SDL2_RTF_DEFAULT_VERSION "${_SDL2_RTF_DEFAULT_VERSION}" CACHE STRING
  "default SDL2_rtf package version in <major>.<minor>.<patch> format")
unset(_SDL2_RTF_DEFAULT_VERSION)
